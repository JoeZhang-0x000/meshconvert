...
void
readMfem(ifstream &fin, vector<Node *> &nodeList, vector<Element *> &elementList, vector<Element *> &boundaryList) {
...
void
writeMfem(ofstream &fout, vector<Node *> &nodeList, vector<Element *> &elementList, vector<Element *> &boundaryList) {
    fout << "MFEM mesh v1.x\n";
    fout << endl;
    fout << "dimension\n";
    fout << DIM << "\n";
